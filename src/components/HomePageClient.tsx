...
export default function HomePageClient({ 
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen p-8 space-y-8">
      ...
      <Link href={{ pathname: '/' }} className="block w-full max-w-md p-6 bg-blue-500 text-white rounded-lg shadow-lg hover:bg-blue-600 transition-colors duration-300 text-center">
      ...
      <Link href={{ pathname: '/provider' }} className="block w-full max-w-md p-6 bg-green-500 text-white rounded-lg shadow-lg hover:bg-green-600 transition-colors duration-300 text-center">
