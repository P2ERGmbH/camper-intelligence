...
export default function ToggleInput({
  ...
  return (
    <div className="flex flex-col md:flex-row gap-4 md:gap-[68px] h-auto md:h-[56px] items-start md:items-center relative shrink-0 w-full">
      ...
      <div className="content-stretch flex gap-[4px] items-center relative shrink-0 w-full md:w-auto">
        <div className="content-stretch flex gap-[9px] items-center relative shrink-0 w-auto">
          ...
          />
          <p className="font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[1.3] relative shrink-0 text-[16px] text-black">
            {t('yes')}
          </p>
        </div>
        {checkboxChecked && inputId && inputName && onInputChange && (
          <div className="border border-[#626680] border-solid box-border content-stretch flex items-center justify-between p-[16px] relative rounded-[12px] shrink-0 w-[194px]">
            <input
              type="text"
              name={inputName}
              id={inputId}
            ...
            <div className="relative shrink-0 size-[24px]">
              <Image alt="Edit icon" className="block max-w-none size-full" src="/assets/svg/uil-pen.svg" width={24} height={24} />
            </div>
          </div>
        )}
      </div>
