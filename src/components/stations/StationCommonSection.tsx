        ...
        <div className="bg-white p-4 sm:p-6 md:p-8 lg:p-[64px] rounded-[32px] flex flex-col gap-4">
            <div className="content-stretch flex flex-col gap-[32px] items-start relative shrink-0 w-full">
                <div
                    ...
                    <div className="relative shrink-0 size-[32px]">
                        <Image alt="Settings icon" className="block max-w-none size-full"
                               src="/assets/svg/uil-setting.svg" width={32} height={32}/>
                    </div>
                ...
                <div className="content-start flex flex-wrap gap-4 items-start relative shrink-0 w-full">
                    ...
                    <InputField label={t('vehiclecount')} id="vehiclecount" name="vehiclecount" type="number"
                                value={formData.vehiclecount as number || 0} onChange={handleFormChange}
                                initialValue={initialData.vehiclecount as number || 0}/>
                </div>
            </div>
            ...
            <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full">
                ...
                <div className="content-start flex flex-wrap gap-[8px] items-start relative shrink-0 w-full">
                    <div
                        className="bg-[#def6e7] border border-[#3d8362] border-solid box-border content-stretch flex gap-[10px] items-center px-[16px] py-[12px] relative rounded-[84px] shrink-0">
                        <div className="h-[20px] relative shrink-0 w-[16.954px]">
                            <Image alt="Paypal logo" className="block max-w-none size-full"
                                   src="/assets/svg/logos-paypal.svg" width={16.954} height={20}/>
                        </div>
                    ...
                    <div
                        className="bg-[#def6e7] border border-[#3d8362] border-solid box-border content-stretch flex gap-[10px] h-[44px] items-center px-[16px] py-[12px] relative rounded-[84px] shrink-0">
                        <div className="h-[16px] relative shrink-0 w-[49.349px]">
                            <Image alt="Visa logo" className="block max-w-none size-full"
                                   src="/assets/svg/logos-visa.svg" width={49.349} height={16}/>
                        </div>
                        <p className="font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[1.3] relative shrink-0 text-[#2a6047] text-[14px]">
                            Visa
                        </p>
                    ...
                    <div
                        className="border border-[#ccced7] border-solid box-border content-stretch flex gap-[10px] items-center px-[16px] py-[12px] relative rounded-[84px] shrink-0">
                        <div className="h-[20px] relative shrink-0 w-[25.729px]">
                            <Image alt="Mastercard logo" className="block max-w-none size-full"
                                   src="/assets/svg/logos-mastercard.svg" width={25.729} height={20}/>
                        </div>
                    ...
                    <div
                        className="border border-[#ccced7] border-solid box-border content-stretch flex gap-[10px] items-center px-[16px] py-[12px] relative rounded-[84px] shrink-0">
                        <div className="h-[20px] relative shrink-0 w-[25.729px]">
                            <Image alt="Maestro logo" className="block max-w-none size-full"
                                   src="/assets/svg/logos-maestro.svg" width={25.729} height={20}/>
                        </div>
                        <p className="font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[1.3] relative shrink-0 text-[14px] text-black">
                            Maestro
                        </p>
                    ...
                    <div
                        ...
                        <div className="h-[20px] relative shrink-0 w-[35.955px]">
                            <Image alt="Klarna logo"
                                   className="absolute inset-0 max-w-none object-50%-50% object-cover pointer-events-none size-full"
                                   src="/assets/img/image5.png" width={35.955} height={20}/>
                        </div>
                        <p className="font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[1.3] relative shrink-0 text-[14px] text-black">
                            Klarna
                        </p>
                    ...
                    <div
                        className="border border-[#ccced7] border-solid box-border content-stretch flex gap-[10px] h-[44px] items-center px-[16px] py-[12px] relative rounded-[84px] shrink-0">
                        <div className="h-[18px] relative shrink-0 w-[43.678px]">
                            <Image alt="Apple Pay logo" className="block max-w-none size-full"
                                   src="/assets/svg/logos-apple-pay.svg" width={43.678} height={18}/>
                        </div>
                        <p className="font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[1.3] relative shrink-0 text-[14px] text-black">
                            Apple Pay
                        </p>
                    ...
                    <div
                        ...
                        <div className="h-[20px] relative shrink-0 w-[50.196px]">
                            <Image alt="Google Pay logo" className="block max-w-none size-full"
                                   src="/assets/svg/logos-google-pay.svg" width={50.196} height={20}/>
                        </div>
                        <p className="font-['Plus_Jakarta_Sans:Regular',_sans-serif] font-normal leading-[1.3] relative shrink-0 text-[14px] text-black">
                            Google Pay
                        </p>
                    ...
                    <div
                        className="bg-[#f7f7f7] border border-[#ccced7] border-solid box-border content-stretch flex gap-[10px] items-center px-[16px] py-[12px] relative rounded-[84px] shrink-0">
                        ...
                        <div className="relative shrink-0 size-[20px]">
                            <Image alt="Plus icon" className="block max-w-none size-full" src="/assets/svg/uil-plus.svg"
                                   width={20} height={20}/>
                        </div>
                    </div>
                </div>
