          ...
          <div className="mt-8">
            <StationEditForm
              station={{
                ...
                parking_info: '',
                parking_info_available: false,
                shopping_info: '',
                shopping_info_available: false,
                fuel_station_info: '',
                fuel_station_info_available: false,
                guest_toilet: '',
                guest_toilet_available: false,
                lounge_area: '',
                lounge_area_available: false,
                greywater_disposal_info: '',
                greywater_disposal_info_available: false,
                pickup_hours: '',
                return_hours: '',
              }}
